...
if(AMIRAMESH_FOUND)
  ...
  set_property(GLOBAL APPEND PROPERTY ALL_PKG_INCS "${AMIRAMESH_INCLUDE_DIR}")
  set_property(GLOBAL APPEND PROPERTY ALL_PKG_DEFS "HX_HAS_STDIOSTREAM")
  set_property(GLOBAL APPEND PROPERTY ALL_PKG_LIBS "${AMIRAMESH_LIBRARIES}")
endif()
