...
if(ALUGRID_ROOT)
find_path(ALUGRID_PKGCONFIG_DIR alugrid.pc PATH ${ALUGRID_ROOT}
...
get_filename_component(_GUESSED_ALUGRID_ROOT ${ALUGRID_PKGCONFIG_ROOT}/../../ ABSOLUTE)
find_file(ALUGRID_VERSION alugridversion PATH ${_GUESSED_ALUGRID_ROOT}/bin
  NO_DEFAULT_PATH)
...
find_path(ALUGRID_INCLUDE_PATH alugrid_serial.h PATH ${ALUGRID_ROOT} PATH_SUFFIXES include include/serial NO_DEFAULT_PATH DOC "Include path of serial alugrid headers.")
find_path(ALUGRID_INCLUDE_PATH alugrid_serial.h PATH_SUFFIXES include include/serial)

find_library(ALUGRID_LIB alugrid PATH ${ALUGRID_ROOT} PATH_SUFFIXES lib lib32 lib64
...
if(ALUGRID_PARALLEL_FOUND AND MPI_FOUND)
  ...
  find_path(ALUGRID_PARALLEL_INCLUDE_PATH alugrid_parallel.h PATH ${ALUGRID_ROOT} PATH_SUFFIXES include include/parallel NO_DEFAULT_PATH)
