...
function(add_dune_alugrid_flags )
 if(ALUGRID_FOUND)
    cmake_parse_arguments(ADD_ALU "SOURCE_ONLY;OBJECT;NO_LINK_DUNEGRID" "" "" ${ARGN})
    if(ADD_ALU_SOURCE_ONLY)
      ...
      if(ADD_ALU_OBJECT)
        ...
        foreach(_target ${ADD_ALU_UNPARSED_ARGUMENTS})
          if (NOT ADD_ALU_NO_LINK_DUNEGRID)
            target_link_libraries(${_target} dunegrid)
          endif(NOT ADD_ALU_NO_LINK_DUNEGRID)
          target_link_libraries(${_target}
            ${ALUGRID_LIBRARIES} ${METIS_LIBRARIES} ${DUNE_LIBS})
