...
namespace Dune
{
  ...
  auto referenceElement(const Entity< cd, dim, GridImp, EntityImp >& entity )
    -> decltype(referenceElement<typename GridImp::ctype,typename Entity< cd, dim, GridImp, EntityImp >::Geometry::mydimension>(entity.type()))
  {
    typedef typename Entity< cd, dim, GridImp, EntityImp >::Geometry Geo;
