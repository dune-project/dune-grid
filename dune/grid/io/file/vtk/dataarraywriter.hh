...
namespace Dune
{
  ...
  namespace VTK {
    ...
    private:
      ...
      virtual void writeInt32 (std::int_least32_t data) = 0;
      //! write one data element as unsigned integer
      virtual void writeUInt8 (std::uint_least8_t data) = 0;
      //! write one data element as unsigned integer
      virtual void writeUInt32 (std::uint_least32_t data) = 0;
    ...
    private:
      ...
      void writeInt32 (std::int_least32_t data) final
      { write_(data); }
      //! write one unsigned int data element to output stream
      void writeUInt32 (std::uint_least32_t data) final
      { write_(data); }
      //! write one unsigned int data element to output stream
      void writeUInt8 (std::uint_least8_t data) final
      { write_(data); }
