...
// Deprecated: This file is retained for autotools compatibility
// To be removed once autotools are not supported anymore
// The tests in dune/grid/test/yasp replace its functionality
