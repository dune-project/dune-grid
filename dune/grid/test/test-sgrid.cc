...
void testFS940()
{
  ...
  std::cout<<" boundarySegmentIndex "<<i1->boundarySegmentIndex()<<std::endl;

  if (i1->neighbor() != res1[0]
      || i1->boundary() != res1[1]
      || i1->boundarySegmentIndex() != res1[2]
      )
  {
  ...
  std::cout<<" boundarySegmentIndex "<<i2->boundarySegmentIndex()<<std::endl;

  if (i2->neighbor() != res2[0]
      || i2->boundary() != res2[1]
      || i2->boundarySegmentIndex() != res2[2]
      )
  {
    DUNE_THROW(Dune::Exception,
  ...
  if (i1->neighbor() != res2[0]
      || i1->boundary() != res2[1]
      || i1->boundarySegmentIndex() != res2[2]
      )
  {
    DUNE_THROW(Dune::Exception,
